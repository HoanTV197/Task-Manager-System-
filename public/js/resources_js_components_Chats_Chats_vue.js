...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  components: {
    VueChatScroll: vue_chat_scroll__WEBPACK_IMPORTED_MODULE_1__.VueChatScroll
  },
  data: function data() {
    return {
  ...
  methods: (_methods = {
    ...
    return _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee() {
      var isTopicQuestion, userMessage, answer;
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              isTopicQuestion = _arguments.length > 0 && _arguments[0] !== undefined ? _arguments[0] : false;
              userMessage = {
                text: _this2.newMessage,
                sender: 'user'
              };

              _this2.messages.push(userMessage);
              ...
              _context.next = 8;
              return _this2.getAnswerFromFAQ(userMessage.text);
            ...
            case 11:
              _context.next = 13;
              return _this2.getAnswerFromChatGPT(userMessage.text);

            case 13:
              answer = _context.sent;

            case 14:
              _this2.sendBotMessage(answer);
            ...
            case 17:
              ...
              console.error('Error during message processing:', _context.t0);

              _this2.sendBotMessage('Xin lỗi, có lỗi xảy ra khi xử lý tin nhắn của bạn.');
  ...
  }), _defineProperty(_methods, "getAnswerFromChatGPT", function getAnswerFromChatGPT(question) {
    var _this3 = this;
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.prev = 0;
              _context2.next = 3;
              return axios__WEBPACK_IMPORTED_MODULE_2___default().post('https://api.chatgpt.com/v1/chat', {
                messages: [{
                  role: 'system',
                ...
                headers: {
                  ...
                  'Authorization': "Bearer ".concat(_this3.apiKey)
                }
              });

            case 3:
              response = _context2.sent;
              return _context2.abrupt("return", response.data.choices[0].message.content);

            case 7:
              _context2.prev = 7;
              _context2.t0 = _context2["catch"](0);
              console.error('Error fetching response from ChatGPT:', _context2.t0);
